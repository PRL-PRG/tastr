...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // rawascalartype
      char dummy15[sizeof (RawAScalarTypeNodePtr)];

      // s4type
      char dummy16[sizeof (S4TypeNodePtr)];

      // scalartype
      char dummy17[sizeof (ScalarTypeNodePtr)];

      // structtype
      char dummy18[sizeof (StructTypeNodePtr)];

      // symboltype
      char dummy19[sizeof (SymbolTypeNodePtr)];

      // namedtype
      char dummy20[sizeof (TagTypePairNodePtr)];

      // tupletype
      char dummy21[sizeof (TupleTypeNodePtr)];

      // decltype
      char dummy22[sizeof (TypeDeclarationNodePtr)];
      ...
      // nulltype
      // type
      char dummy23[sizeof (TypeNodePtr)];
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_LOGICAL = 283,
        TOKEN_RAW = 284,
        TOKEN_ENVIRONMENT = 285,
        TOKEN_EXPRESSION = 286,
        TOKEN_LANGUAGE = 287,
        TOKEN_SYMBOL = 288,
        TOKEN_EXTERNALPOINTER = 289,
        TOKEN_BYTECODE = 290,
        TOKEN_PAIRLIST = 291,
        TOKEN_S4 = 292,
        TOKEN_WEAKREF = 293,
        ...
        TOKEN_ANY = 297,
        TOKEN_TYPEDECL = 298,
        TOKEN_IDENTIFIER = 299,
        TOKEN_QUOTED_IDENTIFIER = 300,
        TOKEN_LBRACKET = 301,
        TOKEN_LOWER_THAN_OR = 302
      };
    };
...
switch (yytype)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_NULLOP (std::string v, location_type l)
      {
        return symbol_type (token::TOKEN_NULLOP, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_NULLOP (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOKEN_NULLOP, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_TUPLE (std::string v, location_type l)
      {
        return symbol_type (token::TOKEN_TUPLE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_TUPLE (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOKEN_TUPLE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOKEN_LIST, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_LIST, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
