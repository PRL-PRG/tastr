  ...
  private:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_LOGICAL = 279,
        TOKEN_RAW = 280,
        TOKEN_ENVIRONMENT = 281,
        TOKEN_EXPRESSION = 282,
        TOKEN_LANGUAGE = 283,
        TOKEN_SYMBOL = 284,
        TOKEN_EXTERNALPOINTER = 285,
        TOKEN_BYTECODE = 286,
        TOKEN_PAIRLIST = 287,
        TOKEN_S4 = 288,
        TOKEN_ANY = 289,
