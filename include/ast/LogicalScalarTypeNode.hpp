#ifndef TASTR_AST_LOGICAL_SCALAR_TYPE_NODE_H
#define TASTR_AST_LOGICAL_SCALAR_TYPE_NODE_H
...
class LogicalScalarTypeNode final: public ScalarTypeNode {
  public:
    explicit LogicalScalarTypeNode(const std::string& identifier)
...
#endif /* TASTR_AST_LOGICAL_SCALAR_TYPE_NODE_H */
