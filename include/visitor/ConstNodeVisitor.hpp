...
class ConstNodeVisitor {
  public:
    ...
    virtual void visit(const tastr::ast::EofNode& node) = 0;
    ...
    virtual void visit(const tastr::ast::ClassTypeNode& node) = 0;
    ...
    virtual void visit(const tastr::ast::IntersectionTypeNode& node) = 0;
